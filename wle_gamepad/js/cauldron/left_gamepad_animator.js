...
WL.registerComponent('left_gamepad_animator', {
    ...
    update: function (dt) {
        ...
        //SELECT
        let button = PP.LeftGamepad.getButtonInfo(PP.ButtonType.SELECT);
        ...
        //SQUEEZE
        button = PP.LeftGamepad.getButtonInfo(PP.ButtonType.SQUEEZE);
        ...
        //THUMBSTICK
        button = PP.LeftGamepad.getButtonInfo(PP.ButtonType.THUMBSTICK);
        ...
        //BOTTOM BUTTON
        button = PP.LeftGamepad.getButtonInfo(PP.ButtonType.BOTTOM_BUTTON);
        ...
        //TOP BUTTON
        button = PP.LeftGamepad.getButtonInfo(PP.ButtonType.TOP_BUTTON);
    ...
    updateThumbstickValues: function () {
        let axesInfo = PP.LeftGamepad.getAxesInfo();
        let text = "0.000";
